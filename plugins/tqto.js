...
`
    ...
    /*
    const buttons = [
        { buttonId: usedPrefix + 'sc', buttonText: { displayText: 'Source Code Bot ✨' }, type: 1 }
    ]
    const logo = await (await fetch("https://telegra.ph/file/38ff21d724ecd78d7d0f8.jpg")).buffer()
    const buttonMessage = {
        ...
        contextInfo: {
                ...
                "externalAdReply": {
                    ...
                    "body": 'ʙy ᴀɢᴜᴢ ꜰᴀᴍɪʟɪᴀ',
                    "thumbnail": logo,
                    "sourceUrl": "https://www.instagram.com/aguzfamilia"
                }
        },
        caption: tqto,
        footer: 'ʙy ᴀɢᴜᴢ ꜰᴀᴍɪʟɪᴀ',
        buttons: buttons,
        headerType: 1
    }
    return await conn.sendMessage(jid, buttonMessage, { quoted: m, ephemeralExpiration: 86400, forwardingScore: 99999, isForwarded: true })
    */
}
handler.help = ['tqto']
handler.tags = ['info']
